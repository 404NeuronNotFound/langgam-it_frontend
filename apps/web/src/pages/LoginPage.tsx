          ...
          <div className="li-left">
            ...
            <div className="li-brand">
              ...
              <p className="li-tagline">
                Track income, master your spending habits,
                <br />
            ...
            <form onSubmit={handleSignIn} noValidate>
              ...
              <div className="li-field">
                <div className="li-label-row">
                  <label className="li-label" htmlFor="li-username">
                    Username
                  </label>
                </div>
              ...
              <div className="li-field">
                <div className="li-label-row">
                  <label className="li-label" htmlFor="li-password">
                    Password
                  </label>
                  <button type="button" className="li-forgot">
                    Forgot password?
                  </button>
                </div>
                <div className="li-input-wrap">
