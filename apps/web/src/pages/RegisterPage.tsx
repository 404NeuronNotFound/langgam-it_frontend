...
// ------------------------------------------------------------------
// Langgam-It — Register Page
// Matches LoginPage.tsx style exactly
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rg-input-error {
          ...
          box-shadow: 0 0 0 3px rgba(153,60,29,0.08) !important;
        }
        ...
        @media (max-width: 680px) {
          ...
          .rg-shell       { border-radius: var(--radius-md); }
        }

        @media (max-width: 480px) {
          .rg-right { padding: 1.5rem 1.25rem; }
          .rg-row   { grid-template-columns: 1fr; gap: 0; margin-bottom: 0; }
          .rg-row .rg-field { margin-bottom: 13px; }
        }
      `}</style>
        ...
        <div className="rg-shell">
          ...
          <div className="rg-right">
            ...
            <p className="rg-signin">
              ...
              <button type="button" className="rg-signin-link">Sign in</button>
            </p>
          </div>
